...
def build_dynamic_sidebar(feature_info):
            ...
            children += [
                ...
                html.Div([
                    dcc.Input(id={"type":"continuous-filter-min","column_name":nm},
                              ...
                              style={"width":"45%","margin-right":"5px",'color': '#000000', 'background-color': '#ffffff'}),
                    dcc.Input(id={"type":"continuous-filter-max","column_name":nm},
                              type="number", placeholder=f"Max {nm}",
                              style={"width":"45%",'color': '#000000', 'background-color': '#ffffff'})
    ...
    children += [
        html.Label("Select Coordinate Systems"),
        ...
        dcc.Dropdown(
            ...
            style={"margin-bottom":"10px", 'color': '#000000', 'background-color': '#ffffff'}
        ),
        ...
        dcc.Dropdown(
            ...
            value="viridis", style={"margin-bottom":"10px",'color': '#000000', 'background-color': '#ffffff'}
        ),
        ...
        dcc.Input(
            ...
            step=1,
            value=3,
            style={"margin-bottom": "10px", "width": "100%",'color': '#000000', 'background-color': '#ffffff'}
        ),
...
app.layout = html.Div([
    ...
    store_overlay,
    html.Div([
        # You can toggle color style on/off by commenting/uncommenting
        html.H3("Dynamic Coordinate System Plots" 
                # , style={"color":"white"}
               ),
        ...
        html.Div(
            ...
            style={
                #'color': 'white',        # comment/uncomment as needed
                'textAlign': 'center',
                'marginTop': '10px',
                'marginBottom': '20px'
            }
        ...
        html.Div([
            dcc.Input(
                id='bin-name-input', type='text',
                placeholder='Enter bin name',
                style={
                    'margin-right':'10px',
                    #'color': '#000000',          # input text color
                    #'background-color': '#ffffff' # input bg color
                }
            ),
            html.Button('Create Bin',  id='create-bin-button',  n_clicks=0),
            html.Button('Inspect Bin', id='inspect-bin-button', n_clicks=0,
                        style={'margin-left':'10px'}),
            html.Button('Overlay Points', id='overlay-points-button', n_clicks=0,
                        style={'margin-left':'10px'}),
    ...
    style={'margin-left':'22rem','padding':'2rem'}  # can toggle panel spacing
    )
], 
#style={'backgroundColor':'#2b2b2b'}  # outermost div bg
)
